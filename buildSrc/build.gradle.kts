...
dependencies {
    ...
    val agp = dependabot("com.android.tools.build:gradle:7.0.4") { "android-gradle-plugin" }
    ...
    val keeper = dependabot("com.slack.keeper:keeper:0.11.1") { "keeper-gradle-plugin" }
    ...
    dependabot("com.karumi:shot:5.12.2") { "shot-gradle-plugin" }
    ...
    // Kotlinx
    dependabot("org.jetbrains.kotlinx:kotlinx-coroutines-core:1.6.0") { "kotlinx-coroutines-core" }
    dependabot("org.jetbrains.kotlinx:kotlinx-coroutines-core-jvm:1.6.0") { "kotlinx-coroutines-jvm" }
    dependabot("org.jetbrains.kotlinx:kotlinx-coroutines-android:1.6.0") { "kotlinx-coroutines-android" }
    dependabot("org.jetbrains.kotlinx:kotlinx-serialization-core:1.3.2") { "kotlinx-serialization-core" }
    dependabot("org.jetbrains.kotlinx:kotlinx-serialization-core-jvm:1.3.2") { "kotlinx-serialization-jvm" }
    dependabot("org.jetbrains.kotlinx:kotlinx-serialization-json:1.3.2") { "kotlinx-serialization-json" }
    ...
    dependabot("org.slf4j:slf4j-nop:1.7.33") { "slf4j" }
    ...
    dependabot("com.karumi:shot-android:5.13.0") { "shot-android" }
