...
dependencies {
    ...
    dependabot("org.jetbrains.kotlinx:kotlinx-coroutines-core-jvm:1.6.4") { "kotlinx-coroutines-jvm" }
    dependabot("org.jetbrains.kotlinx:kotlinx-coroutines-android:1.6.4") { "kotlinx-coroutines-android" }
    ...
    // Networking
    dependabot("com.squareup.okhttp3:okhttp:4.10.0") { "square-okhttp" }
    dependabot("com.squareup.okhttp3:logging-interceptor:4.10.0") { "square-okhttp-logging" }
    ...
    dependabot("org.jetbrains.kotlinx:kotlinx-coroutines-test:1.6.4") { "kotlinx-coroutines-test" }
    ...
    dependabot("com.squareup.okhttp3:mockwebserver:4.10.0") { "okhttp-mockwebserver" }
