...
dependencies {
    ...
    val agp = dependabot("com.android.tools.build:gradle:7.1.2") { "android-gradle-plugin" }
    val kgp = dependabot("org.jetbrains.kotlin:kotlin-gradle-plugin:1.6.20") { "kotlin-gradle-plugin" }
